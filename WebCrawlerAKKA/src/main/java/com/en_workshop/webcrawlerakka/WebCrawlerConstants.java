...
public class WebCrawlerConstants {
    ...
    /* Other */
    public static final int DOMAINS_CRAWL_MAX_COUNT = 1; // Maximum number of domains to crawl at one time
    public static final long DOMAINS_REFRESH_PERIOD = 1 * 60 * 1000; // 10 minutes
    public static final long DOMAIN_DEFAULT_COOLDOWN = 200; // 60 seconds
}
